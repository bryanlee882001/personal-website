  ...
  return (
    <div className={`container ${darkMode ? 'dark-mode' : ''}`}>
      ...
      <div className="description_container">
        ...
        as well as assisting in the development of Electrocardiogram (ECG) compression algorithms and data tools for cardiac monitoring @ the <a href="https://dcsg.cs.umn.edu/" target="blank">Distributed Computing Systems Group</a>.</p>
